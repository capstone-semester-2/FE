...
const RecordingControls = ({
  ...
  onSignWordClick,
    ...
    const phrasesByCategory = {
      bank: ['이것 좀 도와주시겠어요?', '통장을 만들고 싶어요.', '카드 재발급 해주세요.', '비밀번호를 잊어버렸어요.', '현금 인출 도와주세요.'],
      hospital: ['머리가 너무 아파요.', '접수는 어디서 하나요?', '통증 위치는 여기입니다.', '진료 예약 확인부탁드려요.'],
      pharmacy: ['약을 처방받으려고 해요.', '삼키기 쉬운 약으로 부탁해요.', '알레르기 주의해주세요.', '증상에 맞는 약을 추천해주세요.'],
      cafe: ['아메리카노 따뜻한 거 한 잔이요.', '화장실 비밀번호가 뭔가요?', '와이파이 비밀번호 알려주세요.', '포장해 주세요.'],
      restaurant: ['자리 있나요?', '메뉴 추천 부탁해요.', '덜 맵게 해주세요.', '계산서 주세요.'],
